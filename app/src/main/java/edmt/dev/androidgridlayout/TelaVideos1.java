...
public class TelaVideos1 extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        feed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent9 = new Intent(TelaVideos1.this, Feed.class);
        ...
        btnLimite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (op){
                    case "videosCA":
                        Intent intent1 = new Intent(TelaVideos1.this, TelaVideos.class);
                    ...
                    case "videosGA":
                        Intent intent2 = new Intent(TelaVideos1.this, TelaVideos2.class);
        ...
        btnDerivada.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (op){
                    case "videosCA":
                        Intent intent3 = new Intent(TelaVideos1.this, TelaVideos1.class);
                    ...
                    case "videosGA":
                        Intent intent4 = new Intent(TelaVideos1.this, TelaVideos1.class);

                        Bundle dados6 = new Bundle();
                        dados6.putString("op", "videosGA");
        ...
        btnIntegral.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (op){
                    case "videosCA":
                        Intent intent5 = new Intent(TelaVideos1.this, TelaVideos2.class);
                    ...
                    case "videosGA":
                        Intent intent6 = new Intent(TelaVideos1.this, TelaVideos.class);

                        Bundle dados8 = new Bundle();
                        dados8.putString("op", "videosGA");
                ...
                switch (op){
                    case "videosCA":
                        ...
                        back.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent intent9 = new Intent(TelaVideos1.this, Opcoes.class);

                                Bundle dados8 = new Bundle();
                                dados8.putString("ma", "cal");
                        ...
                        player.cuePlaylist("PLf1lowbdbFIAURvpD8Qy8PqwrMjwx0N64");break;
                    ...
                    case "videosGA":
                        ...
                        player.cuePlaylist("PLEfwqyY2ox86GfOHvSgN5iJZKNN_AUlU_");break;
                }
            }
        }
